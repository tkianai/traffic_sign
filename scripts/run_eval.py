...
import sys
sys.path.append('/Users/tiankai/competitions/traffic_sign')
print(sys.path)
...
def parse_args():
    ...
    parser.add_argument('--score-thr', type=float, default=0.8, help="middle file")
...
def run(args):
    ...
    if args.pn_file is None:
        ...
        st.bbox_to_polygons(save_name='work_dirs/conlusions/results_polygons.json')
